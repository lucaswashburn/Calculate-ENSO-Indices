...
lat0 = -10
lat1 = 0
long0 = Convert_to_360_long(-90)
long1 = Convert_to_360_long(-80)
...
for counter = 1:size(T,4)
    ...
    Nino_12_temperatures = temperatures_permuted([lat10S:lat0],[long90W:long80W]);
    Nino_12_areas = areas_permuted([lat10S:lat0],[long90W:long80W]);
